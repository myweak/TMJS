...
class SQColor {
  static Color navColor = Color(0xFFFFFFFF);
  static Color themeColor = Color(0xFFFF901D);
  static Color codeColor = Color(0xFFFFECD6);
...
//  static Color lightGray = Color(0xFFEEEEEE);
  ...
  static Color textGrayColor = Color(0xff909090);
  static Color bgGrayColor = Color(0xffF0F0F0);
}
