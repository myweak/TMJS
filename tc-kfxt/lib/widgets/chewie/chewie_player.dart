...
import 'package:school/widgets/chewie/player_with_controls.dart';
...
class ChewieController extends ChangeNotifier {
  ...
  ///视频状态：1，可以试看；2，试看中；3：付费才可以观看；4：免费观看
  int videoPayStatus;
  ...
  void setVideoPayStatus(int vPayStatus) async {
    videoPayStatus = vPayStatus;
    notifyListeners();
  }
